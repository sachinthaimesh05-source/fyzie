    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
      ...
      >
        ...
        <div className="mt-6 space-y-6">
          ...
          {/* Method Details */}
          {selectedMethod === 'bank' && (
            <div className="p-4 rounded-xl bg-slate-900/80 border border-white/10 text-xs space-y-2 animate-in fade-in duration-200">
          ...
          {selectedMethod === 'qr' && (
            <div className="p-4 rounded-xl bg-slate-900/80 border border-white/10 text-center space-y-3 animate-in fade-in duration-200">
