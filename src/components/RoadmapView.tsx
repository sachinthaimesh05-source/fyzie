...
export const RoadmapView: React.FC = () => {
  ...
  const roadmapMilestones = [
    ...
    },
    {
      ...
      volId: 9,
      firstChId: 'ch-98',
      title: 'AI යුගය, පද්ධති සැලසුම්කරණය සහ වෘත්තීය අනාගතය',
      enTitle: 'AI Era Engineering, System Design & Career Launch',
      duration: 'නොනවතින',
      badge: 'ජයග්‍රහණය',
      techs: ['AI-assisted Dev', 'System Architecture', 'Portfolio Building', 'Interviews', 'Global Remote Work'],
